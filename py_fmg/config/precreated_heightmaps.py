"""
Registry of precreated heightmaps (id -> friendly name), ported from
Fantasy-Map-Generator/config/precreated-heightmaps.js.

Used by HeightmapGenerator.from_precreated, CLI, and API to list options.
"""

PRECREATED_HEIGHTMAPS = {
...
def list_precreated() -> dict:
    """Return the id->metadata mapping for precreated heightmaps."""
    return PRECREATED_HEIGHTMAPS
