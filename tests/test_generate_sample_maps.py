...
def create_map_with_full_pipeline(
    width=1200, height=1000, cells_desired=10000, template="archipelago", seed="default"
):
    ...
    print(
        f"     Initial: {water_cells} water cells ({water_cells/len(heights)*100:.1f}%), "
    ...
    print(
        f"     Packed to {len(packed.points)} cells "
